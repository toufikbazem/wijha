...
function Header({
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              ...
              <img
                src={img1}
                alt="Logo"
                className="w-20 pt-3 hidden lg:block"
              />
            </div>
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-30 border-t border-white/10 backdrop-blur-md bg-[#06192d]/95">
        <div className="grid grid-cols-4 h-16">
          <Link
            to="/"
            className={`${
              pathname === "/" ? "text-[#2E8CB8]" : "text-gray-100"
            } hover:text-[#5DADE2]! transition flex flex-col items-center justify-center gap-1 text-xs font-medium`}
          >
          ...
          <Link
            to="/Companies"
            className={`${
              pathname === "/Companies" ? "text-[#2E8CB8]" : "text-gray-100"
            } hover:text-[#5DADE2]! transition flex flex-col items-center justify-center gap-1 text-xs font-medium`}
          >
          ...
          {user?.role === "employer" ? (
            <Link
              to="/dashboard?tab=profileAccess"
              className={`${
                pathname === "/dashboard?tab=profileAccess"
                  ? "text-[#2E8CB8]"
                  : "text-gray-100"
              } hover:text-[#5DADE2]! transition flex flex-col items-center justify-center gap-1 text-xs font-medium`}
            >
            ...
            <Link
              to="/jobSearch"
              className={`${
                pathname === "/jobSearch" ? "text-[#2E8CB8]" : "text-gray-100"
              } hover:text-[#5DADE2]! transition flex flex-col items-center justify-center gap-1 text-xs font-medium`}
            >
          ...
          <Link
            to="/contacts"
            className={`${
              pathname === "/contacts" ? "text-[#2E8CB8]" : "text-gray-100"
            } hover:text-[#5DADE2]! transition flex flex-col items-center justify-center gap-1 text-xs font-medium`}
          >
