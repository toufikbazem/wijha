...
function AboutUs() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0D3B72]/20 z-0">
      ...
      {/* What is Wijha */}
      <section className="max-w-5xl h-full mx-auto px-6 py-20 ">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-linear-to-br from-white to-[#F0F8FF] border-2 border-[#0D3B72]/50 hover:border-[#0D3B72]/90 rounded-3xl p-10 text-center">
              <div className="w-20 h-20 bg-[#0D3B72]/80 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
      ...
      {/* Vision & Mission */}
      <section className="bg-[#0D3B72]/10 py-20">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            {/* Vision */}
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-[#0D3B72]/80 rounded-2xl flex items-center justify-center mb-5">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-900 mb-4">{t("aboutMissionDesc")}</p>
              <ul className="space-y-2">
                {missionItems.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-gray-900">
                    <CheckCircle className="w-5 h-5 text-[#0D3B72] mt-0.5 shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 text-[#0D3B72] font-semibold text-sm uppercase tracking-wider mb-3">
            <div className="w-8 h-0.5 bg-[#0D3B72]" />
      ...
      <section className=" text-black bg-[#0D3B72]/10 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">✦ {t("aboutWhyTitle")}</h2>
          <p className="text-xl text-black mb-12 max-w-2xl mx-auto">
            {t("aboutWhyDesc")}
          </p>
          <div className="bg-[#0D3B72]/80 backdrop-blur-sm rounded-3xl px-10 py-8 border border-white/20 max-w-2xl mx-auto">
